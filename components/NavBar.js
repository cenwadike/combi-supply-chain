      ...
      <nav className='fixed w-full flex items-center flex-wrap bg-white px-2 py-2 navbar-expand-lg shadow-md'>
        <Link href='/'>
          <a className='inline-flex items-center p-2 mr-0'>
            <span className='text-xl text-blue-800 hover:text-blue-900 font-bold uppercase tracking-wide'>
              AgroTrace
            </span>
          </a>
        </Link>
        ...
        <div className={`${active ? "" : "hidden"}   w-full lg:inline-flex lg:flex-grow lg:w-auto`}>
          <div className='lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto'>
            <Link href='/dashboard'>
              <a className='p-2 lg:px-4 md:mx-2 text-blue-700 text-center border border-transparent rounded hover:bg-indigo-300 hover:text-indigo-800 transition-colors duration-300'>
                Dashboard
              </a>
            </Link>
            <button
